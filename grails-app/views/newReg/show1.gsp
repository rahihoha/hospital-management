...
Welcome ${newRegInstance.userName} .You have sucessfuly registered for hospital management system.
    ...
    <br/>
 	 ...
 	 cellpadding="2" cellspacing="1" class="tblbdr">
           ...
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${fieldValue(bean:newRegInstance, field:'userName')}</td>
  					</tr>
 
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" >Employee id:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${fieldValue(bean:newRegInstance, field:'empId')}</td>
  					</tr>
