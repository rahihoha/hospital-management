...
HOME</u></b></span> </td>					 
    ...
    <br/>
		...
		<g:form action="savep" name="myform" method="post" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
 ...
 <tr></tr>
             ...
             <tr>
                         ...
                         <tr>
																<td align="left" bgcolor="#A8DAF3" class="headngblue">
															DATE OF CONSULTANCY<span style="color:red">*</span>:</td>
													<td>	<input type="date" name="patDate" id="patDate" value="">
													</td>	</tr>
             <tr>
																<td align="left" bgcolor="#A8DAF3" class="headngblue">
															CONSULTING DOCTOR<span style="color:red">*</span>:</td>
<td>	<input type="text" name="patDoc" id="patDoc" value="">
             ...
             <tr>
													...
													<td>	<input type="text" name="patMobile" id="patMobile" value="">
													</td>	</tr>
...
<script language="JavaScript" type="text/javascript">
 ...
 frmvalidator.addValidation("patMobile","req","Please enter Mobile no");
 ...
 frmvalidator.addValidation("patMobile","numeric","mob no should be numeric");
