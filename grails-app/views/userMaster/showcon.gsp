...
<table width="1003" border="0" align="center" cellpadding="0"
	...
	<a href="localhost:8080/hospital/userMaster/home"><span id="span10" style="font: normal px verdana; color: white;align="left"><u><b>
HOME</u></b></span> </td>					 
 ...
 ${ConsultingPatInstance.patName} has been sucessfuly registered in our hospital data for Consultation.
    ...
    <br/>
 	 ...
 	 cellpadding="2" cellspacing="1" class="tblbdr">
           ...
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patName}</td>
  					</tr>
 
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Id:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${fieldValue(bean:ConsultingPatInstance, field:'id')}</td>
  					</tr>
 
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Age:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patAge}</td>
  					</tr>
	
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Sex:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patSex}</td>
  					</tr>						
  					
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Consultancy Date:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patDate}</td>
  					</tr>
  					
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Doctor Assigned:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patDoc}</td>
  					</tr>
						
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Mobile:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patMobile}</td>
  					</tr>								
  					
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Address:</td>
           <td width="60%" align="left" class="headngblue1" bgcolor="#E8F6F9">${ConsultingPatInstance.patAdd}</td>
  					</tr>
  								</td>
															</tr>
	
						 <tr height="10px" width="100%"><td bgcolor="#A8DAF3"></td><td bgcolor="#A8DAF3">
	<a href="/hospital/userMaster/consultingPat.gsp"><span id="span10" style="font: normal px verdana; color: white;align="center"><u><b>
Register Another Patient</u></b></span> </td>					 
