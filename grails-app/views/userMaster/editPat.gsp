...
HOME</u></b></span> </td>					 
	...
	<form action="edit1" method="post">
 	 ...
 	 cellpadding="2" cellspacing="1" class="tblbdr">
           ...
           <td><input type="text" name="patName" id="patName" value="${PatRegInstance.patName}"></td>
  					</tr>
 
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Id:</td>
          <td><input type="text" name="id" id="id" value="${PatRegInstance.id}" readonly></td>
  					</tr>
 
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Age:</td>
        <td><input type="text" name="patAge" id="patAge" value="${PatRegInstance.patAge}"></td>
  	 					</tr>
	
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Sex:</td>
        <td><input type="text" name="patSex" id="patSex" value="${PatRegInstance.patSex}"></td>
  	 					</tr>						
  					
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Admission Date:</td>       
  	       <td><input type="date" name="patDate" id="patDate" value="${PatRegInstance.patDate}"></td>
  	
  					</tr>
  					
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Doctor Assigned:</td>
                <td><input type="text" name="patDoc" id="patDoc" value="${PatRegInstance.patDoc}"></td>
  			</tr>
						
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Room No:</td>
              <td><input type="text" name="patRoom" id="patRoom" value="${PatRegInstance.patRoom}"></td>
  					</tr>								
  						
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Room Type:</td>
        <td><input type="text" name="patRoomT" id="patRoomT" value="${PatRegInstance.patRoomT}"></td>
  					</tr>								
  									
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Mobile:</td>
        <td><input type="text" name="patMob" id="patMob" value="${PatRegInstance.patMob}"></td>
  	 					</tr>								
  								
			<tr class="headngblue txt4"  >
              <td width="40%" align="left" class="headngblue" bgcolor="#A8DAF3" > Patient's Address:</td>
               <td><input type="text" name="patAdd" id="patAdd" value="${PatRegInstance.patAdd}"></td>
  				</tr>
  								</td>
															</tr>
	<tr>
