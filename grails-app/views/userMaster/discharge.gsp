...
HOME</u></b></span> </td>					 
    ...
    <br/>		<g:if test="${flash.message}">
		...
		<g:form action="discharge" name="myform" method="post" >
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="countrytabs" >
     ...
     <tr>
              <br>
               <td width="95%" align="left" class="headngbig" bgcolor="">TO DISCHARGE A PATIENT :</td></tr>
     <tr>
     <tr></tr>
...
<table>           <td width="95%" align="left"  bgcolor="">ENTER PATIENT ID :</td></tr>
   <tr><td>  <input type="text" name="patName" id="patName" value="" />
                ...
                <tr><td>
<input type="submit" id="submit" value="SUBMIT" name="submit" class="actionbutton">   </td> </tr></table>           			</g:form>
            <br />
            <br />
            </br>
